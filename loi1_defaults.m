...
defaults.testbb         = 1; % 1 = test button box before start, 0 = skip
...
%==========================================================================
defaults.maxDur         = 1.40;   % (max) dur of trial 
defaults.ISI            = 0.10;   % dur of interval between trials
defaults.maxRepDur      = 1.00;   % dur of interval between question and   
